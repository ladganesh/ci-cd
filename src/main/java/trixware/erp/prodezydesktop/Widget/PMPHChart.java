 ...
 * @author dell
 */
public class PMPHChart extends javax.swing.JPanel {
    ...
    private ArrayList<String[]> reportData = null;
    ...
    private String reportMasterType = "PMPH";
    ...
    public PMPHChart() {
        ...
        for (int i = 0; i < singleMonth.size(); i++) {
            ...
            String pmphaddEmpAPICall = "pmphreport?to_date=" + singleMonth.get(i)[0] + "&from_date=" + singleMonth.get(i)[0] + "&freq=";
            //String addEmpAPICall = "production?to_date=2019-04-26&from_date=2019-04-26&freq=";
            //String pmphresult2 = WebAPITester.prepareWebCall(pmphaddEmpAPICall, StaticValues.getHeader(), "");
            //System.out.println("Call"+pmphaddEmpAPICall);
            String pmphresult2 =new WebAPITester().executeWebCall(pmphaddEmpAPICall);
            //System.out.println("Copq result  "+pmphresult2);
            //System.out.println("" + addEmpAPICall);
            if (pmphresult2 != null) {
                pmphbuildTableModelfromJSON(pmphresult2, reportType, singleMonth.get(i)[1]);
            }
        ...
        for (int i = 0; i < reportData.size(); i++) {
            ...
            try {
                ...
                for (int j = i; j <= i; j++) {
                    ...
                    //addQumerative = Integer.parseInt(reportData.get(j)[1]);
                }
                ...
                try {
                    ...
                    for (int j = i; j <= i; j++) {
                        ...
                        //addQumerative = Float.parseFloat(df.format(Float.parseFloat(reportData.get(j)[1])));
                    }
...
//            singleMonth.add ( sdf2.format ( c.getTime () ) + " 00:00:00" );
    ...
    private void pmphbuildTableModelfromJSON(String pmphemployeeJSONList, String reportType, String label) {

        HashMap<String, Object> map = new HashMap<String, Object>();
        JSONObject jObject = new JSONObject(pmphemployeeJSONList);
        ...
        try {
            ...
            if (reportMasterType.equals("PMPH")) {
